  ...
  const svg = await satori(
    {
      ...
      props: {
        ...
        children: [
          ...
          {
            type: 'div',
            props: { style: { width: '60px', height: '2px', background: '#B89A4A', marginBottom: '14px' } }
          },
          {
            type: 'div',
            props: {
              style: { fontFamily: 'Playfair Display', fontWeight: 700, fontStyle: 'italic', fontSize: '68px', color: '#B89A4A', lineHeight: 1, marginBottom: '6px' },
          ...
          },
          {
            type: 'div',
            props: {
              style: { fontFamily: 'Playfair Display', fontWeight: 700, fontSize: '38px', color: '#F6F2E6', lineHeight: 1, marginBottom: '22px' },
